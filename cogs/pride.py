...
class pride(commands.Cog):
    ...
    async def avatar_pride(self, ctx):
        ...
        x += int(y/2)
        print(f'{x}:{y}')
        os.system(f'magick convert -geometry {x}x{y} ./content/images/flags/pedo.png ./content/images/flags/temp/'
                  f'{ctx.message.id}.png')
        os.system(f'magick composite -compose multiply -gravity center ./content/images/flags/temp/'
